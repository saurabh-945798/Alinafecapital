...
const LoanInquirySchema = new mongoose.Schema(
  {
    ...
    applicantNationalIdNumber: { type: String, trim: true, default: "" },
    applicantOccupation: { type: String, trim: true, default: "" },
    homeVillage: { type: String, trim: true, default: "" },
    traditionalAuthority: { type: String, trim: true, default: "" },
    residenceArea: { type: String, trim: true, default: "" },
    residenceDistrict: { type: String, trim: true, default: "" },
    ...
    accountPhoneNumber: { type: String, trim: true, default: "" },
    totalDeductionPerMonth: { type: Number, min: 0, default: 0 },
    collateral: { type: String, trim: true, default: "" },
    approvedDisbursedLoanAmount: { type: Number, min: 0, default: 0 },
    approvedTotalDeductionPerMonth: { type: Number, min: 0, default: 0 },
    ...
    guarantorTraditionalAuthority: { type: String, trim: true, default: "" },
    guarantorDistrict: { type: String, trim: true, default: "" },
    guarantorResidenceArea: { type: String, trim: true, default: "" },
    guarantorResidenceDistrict: { type: String, trim: true, default: "" },
    declarationAccepted: { type: Boolean, default: false },
    guarantorDeclarationAccepted: { type: Boolean, default: false },
